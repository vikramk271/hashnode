...
Add `Rain_mm` bins (Dry/Drizzly/Stormy)

Calculate snack sales per weather combo (Hot+Dry vs. Cold+Stormy)

Print a **Volcano Alert Level** (🌋→🌋🌋🌋) based on predicted snacks!
